    ...
    <footer className="w-full bg-[#1C1C65] mt-[-300px]" id="contacts">
      <div className="px-4 max-w-[1240px] mx-auto pt-[108px]">
        <div className="border-b border-transparent-gray border-solid pb-14 relative z-30">
          <ul className="hidden sm:flex items-center mx-auto text-white justify-between max-w-[653px] mb-14">
          ...
          <div className="flex items-center justify-between max-w-[250px] mx-auto">
            <a
              className="hover:opacity-60 duration-300 ease-in-out"
              href="https://www.linkedin.com/in/asselzhl/"
              target="_blank"
            >
              <SiLinkedin color="white" size={48} />
            </a>
            <a
              className="hover:opacity-60 duration-300 ease-in-out"
              href="mailto:asselzhly@gmail.com"
              target="_blank"
            >
              <ImMail color="white" size={48} />
            </a>
            <a
              className="hover:opacity-60 duration-300 ease-in-out"
              href="https://github.com/asselzhl"
              target="_blank"
            >
              <SiGithub color="white" size={48} />
            </a>
            <a
              className="hover:opacity-60 duration-300 ease-in-out"
              href="https://t.me/asselzhl"
              target="_blank"
            >
              <SiTelegram color="white" size={48} />
            </a>
          </div>
        </div>
        <p className="pt-[25px] pb-[36px] text-white text-right">
          Made by Assel Zholaushybay
        </p>
      </div>
    </footer>
  );
